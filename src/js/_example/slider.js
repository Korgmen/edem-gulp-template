...
import { init as prepareSliders } from '../modules/func/initSliders.js';

// Пример слайдера со всеми основными опциями Swiper [readme 4.1]
export const init = (root = document) => {
	...
	const customBullets = document.querySelectorAll(
		'.content__block:has([data-slider="example"]) .slider-pagination-custom__bullet',
	);
