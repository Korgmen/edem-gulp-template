...
| `ls` | `lineScale(max, min, 480, 1440)` | размер, который плавно уменьшается на узких экранах *(подробнее — [Адаптивное свойство](scss.md#адаптивное-свойство-linescale-миксин))* |
