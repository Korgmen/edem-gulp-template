...
Состояния компонентов задаются тем, что браузер и так знает об элементе: `dialog[open]`, `details[open]`, `:popover-open`, `[aria-selected="true"]`, `[aria-expanded="true"]`, `:checked`, `:placeholder-shown`. Подробнее — в разделе [Состояния компонентов](#component-states).
...
Пример основного контейнера:
	...
	<div class="tabs-block" data-tabs>
		<div class="tabs-block__link-list">
			<button class="tabs-block__link active" data-tab-link>Ссылка таба 1 (Будет активна изначально благодаря классу active)</button>
			<button class="tabs-block__link" data-tab-link>Ссылка таба 2</button>
			<button class="tabs-block__link" data-tab-link>Ссылка таба 3</button>
		</div>
		<div class="tabs-block__content-list" data-tab-panels>
			<div class="tabs-block__content active" data-tab-panel>
